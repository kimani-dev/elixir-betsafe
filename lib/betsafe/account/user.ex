defmodule Betsafe.Account.User do
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email_address, :first_name, :last_name, :msisdn, :password])
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email_address, Betsafe.Repo)
  ...
  """
  def valid_password?(%Betsafe.Account.User{hashed_password: hashed_password}, password)
