defmodule BetsafeWeb.UserControllerTest do
  use BetsafeWeb.ConnCase

  import Betsafe.AccountFixtures

  @create_attrs %{password: "some password", first_name: "some first_name", last_name: "some last_name", email_address: "some email_address", msisdn: "some msisdn"}
